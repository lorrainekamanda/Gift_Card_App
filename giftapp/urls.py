...
from .views import RegisterView, LoginView,ProductsView,ProductView,ProductCategoryView,ProductsCategoryView,WishlistsView,WishlistView,PasswordChangeView
...
urlpatterns = [
    ...
    path('wishlist-view/<pk>/', WishlistView.as_view(), name='wishlist_view'),
